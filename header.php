...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menubar">
    	<div id="top_nav" class="ddsmoothmenu">
            <ul>
                <li><a href="index.php"  style="background-color:#000"
                <?php
				...
				?>
                >Home</a></li>
                <li><a href="dealers.php" style="background-color:#000"
                <?php
				...
				?>
                >Dealers</a></li>
                <li><a href="vehicles.php" style="background-color:#000"
                <?php
				...
				?>
                >Vehicles</a></li>
                <li><a href="account.php" style="background-color:#000"
                <?php
				...
				?>
                >Account</a> </li>
                <li><a href="viewvehorder.php" style="background-color:#000"
                <?php
				...
				?>
                >Orders</a></li>
               <li><a href="contact.php" style="background-color:#000"
                <?php
