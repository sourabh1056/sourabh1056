...
if(isset($_POST[submitorderst]))
{
	...
	<?php
        $curl = curl_init();
$msg="Order status updated successfully,Status:".$_POST[orderstatus];
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://api.msg91.com/api/sendhttp.php?route=4&sender=TESTIN&message=".$msg."&country=91&mobiles=7676852959&authkey=304271AomalyVV72XD5dd0deb3",
...
$rsorders1 = mysqli_fetch_array($resultorders1);
  ...
  <tr>
    ...
    <td>&nbsp;<?php echo $rsveh[fuel_type]; ?></td>
  </tr>
</table>
<hr />
